...
//switch on 12
	...
	bbuff[10] = 0x01;
	bbuff[11] = 0x0e;
	mtimeout = 5; 	// 50*4 = 250ms
	while (--mtimeout && cmdmutex) {
	vTaskDelay(50 / portTICK_PERIOD_MS);
	}
        cmdmutex = 20;
